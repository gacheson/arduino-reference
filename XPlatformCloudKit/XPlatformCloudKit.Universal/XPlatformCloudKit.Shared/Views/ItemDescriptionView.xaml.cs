...
namespace XPlatformCloudKit.Views
{
    ...
    public sealed partial class ItemDescriptionView : MvxWindowsPage
    {
        ...
        private void LoadWebContent(WebView browser, Item selectedItem)
        {
            ...
            string disableHyperLinksJS = scriptOptions + @"<script type='text/javascript'> window.onload = function() { for (var x=document.links.length-1;x>=0;x--) { document.links[x].removeAttribute(""href"");}};</script>";
